<template>
  <div class="detail">
    ...
    <section class="con">
      <!-- 导航路径区域 -->
      <div class="conPoin">
        <span v-if='categoryView.category1Name'>{{this.categoryView.category1Name}}</span>
        <span v-if='categoryView.category2Name'>{{this.categoryView.category2Name}}</span>
        <span v-if='categoryView.category3Name'>{{this.categoryView.category3Name}}</span>
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for='attr in spuSaleAttrList'
                ...
                <dd changepirce="0"
                    v-for="(att,index) in attr.spuSaleAttrValueList"
                    :key='index'
                    :class="{active:att.isChecked==1}" @click="changeActive(att,attr.spuSaleAttrValueList)">{{att.saleAttrValueName}}</dd>
              </dl>
