    ...
    <div class="main">
      <div class="py-container">
        ...
        <div class="details clearfix">
              ...
              <ul class="sui-nav">
                <li :class="{ active: isOne}"
                  ...
                  <a>综合<span v-show='isOne'
                          class="iconfont"
                          :class="{'icon-direction-down':isDesc,'icon-direction-up':isAsc}"></span></a>
                </li>
          ...
          <div class="goods-list">
            <ul class="yui3-g">
              <li class="yui3-u-1-5"
                ...
                <div class="list-wrap">
                  <div class="p-img">
                   <router-link :to='`/detail/${good.id}`' ><img v-lazy="good.defaultImg" style="height:215px"/></router-link>
                  </div>
                  <div class="price">
                    <strong>
                      <em>¥</em>
          ...
          <Pagination :pageNo='searchParams.pageNo' :pageSize='searchParams.pageSize' :total='total' :continues='5' @goPage='goPage'/>
        </div>
      </div>
    </div>
  </div>
