  ...
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        ...
        <button style='height:38px; width:100px'
...
export default {
  ...
  methods: {
    async getVerCode () {
      try {
        this.phone && (await this.$store.dispatch('getverificationCode', this.phone))
    ...
    async userRegister () {
      ...
      if (success) {
        try {
          ...
          await this.$store.dispatch('registerUser', { phone: this.phone, code: this.code, password: this.password })
